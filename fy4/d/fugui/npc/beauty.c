...
药性使$N失去做人的理智！\n\n"NOR,me,this_object());
        }else
        {
                if (random(3) || me->query("marks/crime") == "rape")
                {
                        ...
                        message_vision(HIW"$N征了怔，停下了手，喜道：“若姑娘也愿意，岂非更好。来，让我好好疼疼你。”
边说着，边凑身上前。\n\n"NOR,me);
                        message_vision(HIY"$n笑地更加灿烂，悠悠道：“这位"+RANK_D->query_respect(me)+"真是有心人呢。你们还不出来吗？”\n\n"NOR,me,this_object());
...
void arresthim(object me)
{
        ...
        if (objectp(me) && present(me,environment()))
        {
                ...
                message_vision("$n对$N冷笑道：“我们在这里追捕着那个采花贼很久了，乖乖跟我们走吧！” \n",me,bukuai1);
...
$N“啊~~！啊~~！”兴奋的尖叫起来，接着昏死过去．．．．\n"NOR,me);
                ...
                }else
                {
                        ...
                        message_vision(HIC"$n从地上站起，冷冷地道：“你一定要为你所做的一切复出代价。”说毕，转身而去。\n"NOR,me,this_object());
                }
                me->set("vendetta/authority", 1);
                me->add("score",-200);
