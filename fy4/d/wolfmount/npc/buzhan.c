...
void create()
{
        ...
        set_skill("move", 140);
        set_skill("xueyeqianzong", 140);
        set_skill("wolf-strike", 140);
        set_skill("animal-training", 140);
        set_skill("assasin-hammer", 140);
        set_skill("cursism", 140);
        set_skill("parry", 140);
        set_skill("dodge", 140);
        set_skill("force", 180);
        set_skill("unarmed", 140);
        set_skill("summonwolf", 140);
