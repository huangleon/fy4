...
void killshanliu(object me)
{
   ...
   acao = present("a cao",this_object());
        if (!acao)
        {
        ...
        ashui = present("a shui",this_object());
        if (!ashui)
        {
...
int valid_leave(object me, string dir)
{
        ...
        {
                if ((assassinator = present("a shui",this_object()) || assassinator= present("a cao",this_object())) && dir == "westup")
                {
