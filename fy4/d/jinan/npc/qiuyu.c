...
void create()
{
        set_name( "冷秋雨", ({ "qiu yu", "leng qiuyu" }) );
...
void greeting(object ob)
{
        ...
        switch( random(10) ) {
                case 0:
                        say( "冷秋雨笑咪咪地向你抛了个媚说道：这位" + RANK_D->query_respect(ob)
                                + "，过来，过来，妾身陪您赌几手！\n");
                        break;
                case 1:
                        say( "冷秋雨将台上的鹘牌切了切道：" + RANK_D->query_respect(ob)
                               + "，看您今天一定会拿到天对儿！\n");
                        break;
                case 2:
                        say( "冷秋雨说道：这位" + RANK_D->query_respect(ob)
                                + "，别怕！进来！ 不会我可以教你！\n");
                        break;
        }   
        return; 
...
int accept_object(object who, object ob)
{
        ...
        string message;
                ...
                if( ob->value() >= 10000) {
                        ...
                        say("冷秋雨向你道了个万福，笑道：谢赏...\n");
                        return 1;
                } else {
                    say("冷秋雨说道：这点钱你还是自己用吧！\n");
                        return 0;
                }
        return 0;
} 
