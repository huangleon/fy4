...
/*      if (n==0) say("巡逻士兵说:整天跑来跑去的真累,下岗后去千金楼放松放松.\n");
        else if (n==1) say("巡逻士兵笑嘻嘻地说:请遵守风云城交通规则.\n");
        else if (n==2) say("巡逻士兵把长剑往地上一插,伸了个懒腰.\n");
        else if (n==4) say("巡逻士兵憧憬地说：狐狸精可真迷人啊，不知道小狐狸多大了。\n");
