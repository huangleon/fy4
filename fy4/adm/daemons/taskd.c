...
int quest_reward(object me, object who,object quest_item) {
        ...
        if(combat_exp<10000) 
                exp = 75+random(combat_exp/50);
   else if(combat_exp<128000)
                exp = 360 - random(3000000/combat_exp);
        else if(combat_exp<1024000)
                exp = 560 - random(45000000/combat_exp);
        else if(combat_exp<2400000)
                exp = 660 - random(300000000/combat_exp);               
        else if(combat_exp<3000000)
                exp = 600 - random(600000000/combat_exp);               
        ...
        if (combat_exp >1000000 && combat_exp <2000000) {
            pot = exp/8 + random(70-50000000/combat_exp);
        }
