...
int conjure(object me, object target)
{
        ...
        if (target->query("dungeon_npc") || target->query("quality")) his_exp = his_exp*3;
                else if (his_exp>5000000 || userp(target)) his_exp=his_exp*3;
        ...
        message_vision(HIY"$N面如土色，不自觉地微微颤动。\n"NOR,me);
        me->start_busy(2);
        return 1;
} 
