...
void invocation(object who, int level)
{
        ...
        set_skill("fall-steps",70+random(level/2));
        set_skill("unarmed",70+ random(level/2));
        set_skill("yue-strike",50+random(level/8));
        
        if (i<3) {
                set_skill("spear", 70 + random(level/2));
                set_skill("yue-spear",50+random(level/8));
                map_skill("parry","yue-spear");
                carry_object("/obj/npc/obj/steel_spear")->wield();
        } else {
                set_skill("hammer", 70 + random(level/2));
                set_skill("liuxing-hammer",50+random(level/5));
   ...
   set("max_force",4000);
        ...
        set("force_factor",30+random(level/8));
        set("possessed",who);
